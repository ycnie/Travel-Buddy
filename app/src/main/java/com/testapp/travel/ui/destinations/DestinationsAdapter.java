...
public class DestinationsAdapter extends RecyclerView.Adapter<DestinationsAdapter.PlaceViewHolder> {
    ...
    ArrayList<com.testapp.travel.data.model.Place> places;
    Context mContext;

    public DestinationsAdapter(Context context, ArrayList<com.testapp.travel.data.model.Place> p) {
        mContext = context;
        places = p;
    }
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        com.testapp.travel.data.model.Place place = places.get(position);
